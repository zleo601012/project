...
对应训练入口位于：`training/flow_anomaly/train.py`

训练命令示例：

```bash
python3 training/flow_anomaly/train.py --dataset dataset/node_1.csv
python training/flow_anomaly/train.py --dataset dataset/node_1.csv
```
...
- `http://127.0.0.1:8101/meta`
- `http://127.0.0.1:8101/infer`
...
```bash
docker build -f services/flow_anomaly_service/Dockerfile -t edge-offload/flow_anomaly_service:local .
